...
export default function TechnicalSkills() {
  ...
  const handleAddSkill = () => {
    if (newSkill.name) {
      ...
      setNewSkill({ name: '', subcategory: 'Programming Languages', level: 1 });
    }
  };
  ...
  return (
    <Card className="p-6">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Masukkan keahlian teknis Anda seperti bahasa pemrograman, framework, database, dan tools.
      </p>

      {/* Form Tambah Skill */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-6">
        <Input
          placeholder="Nama skill (contoh: React, Python, PostgreSQL)"
          value={newSkill.name}
      ...
      <div className="space-y-4">
        ...
        {skills.length === 0 && (
          <div className="text-center py-6 text-gray-500 bg-gray-50 rounded-lg">
            <p>Belum ada technical skill yang ditambahkan.</p>
          </div>
        )}
      </div>
